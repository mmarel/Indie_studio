...
namespace indie
{
    ...
    public:
        Component(std::vector<indie::ISprite*>& sprites, size_t backId, double x, double y, double width, double, double height,
                  indie::Color backColor, indie::Color textColor, std::string text = "");
        virtual ~Component(){}
